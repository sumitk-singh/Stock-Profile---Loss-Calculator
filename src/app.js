...
function calculateStockValue() {
    ...
    if (profitOrLose > 0) {
        output.innerText = "Hey, the profit is " + profitOrLose + " and the percentage is " + profitOrLosePercent + "%";
        document.querySelector("body").style.backgroundColor = "#b8ffd9";
    } else if (profitOrLose < 0) {
        output.innerText = "Ops, the loss is " + profitOrLose + " and the percentage is " + profitOrLosePercent + "%";
